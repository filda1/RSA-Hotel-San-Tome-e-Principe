...
header.masthead {
  ...
  /*background: url("../user/img/ervi.jpg") no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
 /* background:url({{url('/storage/'. $posts[1]->picturehotel )}})  no-repeat center center;*/
 background:url({{url('http://rsaecolodge.pt/app/public/'. $posts[3]->picturehotel )}})  no-repeat center center;
