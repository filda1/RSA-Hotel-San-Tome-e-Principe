...
@media (max-width: 992px){
  ...
  @section('head')
        ...
        <header class="call-to-action text-white text-center fill" ><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-8 mx-auto">
           <br>  <br> <br>
          <h1 class="mb-5" style="color:black;font-family:Century Gothic;font-weight:bold;">{{ __('messages.welcome') }}</h1>
        </div>
