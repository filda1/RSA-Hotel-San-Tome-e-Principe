...
header.masthead {
 ...
 /* background: url("../user/img/cua.jpg") no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
 /* background:url({{url('/storage/'. $posts[1]->picturehotel )}})  no-repeat center center;*/
 background:url({{url('http://rsaecolodge.pt/app/public/'. $posts[4]->picturehotel )}})  no-repeat center center;
