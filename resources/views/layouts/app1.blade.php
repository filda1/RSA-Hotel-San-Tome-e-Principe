...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">  
    ...
    <title>Roça Santo António Ecolodge</title>
 ...
 */body{font-family:Lato,'Helvetica Neue',
  Helvetica,Arial,sans-serif}
    h1,h2,h3,h4,h5,h6{font-family:Lato,'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:700}
    header.masthead{position:relative;background-color:#343a40;background:url(../user/img/bg-masthead.jpg) no-repeat center center;background-size:cover;padding-top:8rem;padding-bottom:8rem}
    header.masthead .overlay{position:absolute;background-color:#212529;height:100%;width:100%;top:0;left:0;opacity:.3}
    header.masthead h1{font-size:2rem}
    @media (min-width:768px){header.masthead{padding-top:12rem;padding-bottom:12rem}header.masthead h1{font-size:3rem}}.showcase .showcase-text{padding:3rem}.showcase .showcase-img{min-height:30rem;background-size:cover}
    ...
    .features-icons-icon{height:7rem}
    .features-icons .features-icons-item 
    .features-icons-icon i{font-size:4.5rem}
    .features-icons .features-icons-item:hover 
    .features-icons-icon i{font-size:5rem}
    ...
    .call-to-action{position:relative;background-color:#343a40;background:url({{url('http://rsaecolodge.pt/app/public/'. $posts[0]->picturehotel )}})  no-repeat center center;background-size:cover;padding-top:7rem;padding-bottom:7rem}
...
header.masthead {
  ...
  /*background: url("../user/img/bg-masthead.jpg") no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
  /*background: url({{url('/storage/'. $posts[1]->picturehotel )}}) no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
  background:url({{url('http://rsaecolodge.pt/app/public/'. $posts[0]->picturehotel )}})  no-repeat center center;
...
.call-to-action {
  ...
  /**background: url("../user/img/bg-masthead.jpg") no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
   ...
   background:url({{url('/storage/'. $posts[1]->picturehotel )}}) 
...
.call-to-action2 {
  position: relative;
  background-color: #343a40;
  background: url("../user/img/1 (1).jpg") no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
