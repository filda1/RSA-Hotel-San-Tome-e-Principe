 ...
 */body{font-family:Lato,'Helvetica Neue',
  Helvetica,Arial,sans-serif}
    ...
    .call-to-action{position:relative;background-color:#343a40;background:url({{url('/storage/'. $posts[1]->picturehotel )}}) no-repeat center center;background-size:cover;padding-top:7rem;padding-bottom:7rem}
...
header.masthead {
  ...
  /*background: url("../user/img/ambi.jpg") no-repeat center center; /** =======>  IMAGEN DE PAG PRINCIPAL*/
 /* background:url({{url('/storage/'. $posts[1]->picturehotel )}})  no-repeat center center;*/
  background:url({{url('http://rsaecolodge.pt/app/public/'. $posts[2]->picturehotel )}})  no-repeat center center;
...
.call-to-action {
  position: relative;
  background-color: #343a40;
  background: url("../user/img/ambiente.jpg") no-repeat center center; /** =======>  IMAGENES REPETIDAS DE OTRAS PAG */
