...
<div class="row" style="max-width:1000px;"
		<div class="col-lg-4">
						<div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
								<h3 class="headingTop text-center" style="color:#47775D;font-weight:bold;font-family:Century Gothic;">{{ __('messages.Pagamentos') }}</h3><br>	
								<p align = "justify" style="font-family:Century Gothic;font-size:18px">{{ __('messages.CuerpoPagamentos') }}</p>
						</div>
                        <form>
