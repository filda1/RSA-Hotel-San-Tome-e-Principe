...
.paymentWrap .paymentBtnGroup .paymentMethod .method.ez-cash {
	background-image: url("/user/img/cash.png");
}
...
<div class="row" style="max-width:1000px;"
		<div class="col-lg-4">
						<div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
								<h3 class="headingTop text-center" style="font-family:Century Gothic;font-size:18px">{{ __('messages.pagamento') }}</h3>	
								<p class="text-center" style="font-family:Century Gothic;font-size:13px">Roça Santo António, São Tomé</p>
						</div>
                        <form method="post" action="{{url('optionspayment2/save')}}">
    {{ csrf_field() }}
                        ...
                        <input  type='hidden' value={{ $person }}  name='persona'  style="  width:20px; 
                                  height:5px;"/> 
                              ...
                              <input  type='hidden' value={{ $checkin}}  name="checkin"  style="  width:20px; 
                                  height:5px;"/> 

                                    <input  type='hidden' value= {{  $checkout }}  name="checkout"  style="  width:20px; 
                                  height:5px;"/> 

                       <input  type='hidden' value= {{  $totalfinal   }}  name="totalfinal"  style="  width:20px; 
                                  height:5px;"/>

                          <input  type='hidden' value= {{  $iva   }}  name="iva"  style="  width:20px; 
                                  height:5px;"/>


						  <input  type='hidden' value= {{  $infoiva   }}  name="infoiva"  style="  width:20px; 
                                  height:5px;"/>
                                  
                                  
                                  
						  <input  type='hidden' value= {{  $numero_dias   }}  name="infoiva"  style="  width:20px; 
                                  height:5px;"/>
                          ...
                          <input type='hidden'  value={{ $checkout}}  name="checkout_extraroom"  style="width:20px height:5px;"/> 
                           ...
                           <input  type='hidden' value={{ $persona }}  name='persona_extraroom'  style="width:20px;height:5px;"/> 



                           <input  type='hidden' value={{$id_extraroom2}} name="id_extraroom2"  style=" width:20px;height:5px;"/> 
                                
                              <input  type='hidden' value={{$price_extraroom2}} name="price_extraroom2"  style="width:20px;height:5px;"/> 
                                 ...
                                 <input  type='hidden' value={{  $total }}  name='total'  style=" width:20px; height:5px;"/> 
                                  ...
                                  <input  type='hidden' value={{ $precio_children }}  name='precio_children'  />  
                                   ...
                                   <input  type='hidden' value={{ $precio_baby }}  name='precio_baby'  />
                                    ...
                                    <input  type='hidden' value={{ $ide3 }}  name='ide3'  />
                                    <input  type='hidden' value={{ $ide4 }}  name='ide4'  /> 
                                    <input  type='hidden' value={{ $ide5 }}  name='ide5'  /> 
                                    <input  type='hidden' value={{ $ide6 }}  name='ide6'  />
                                    
                                     <input  type='hidden' value={{ $precio3 }}  name='precio3'  />
                                     <input  type='hidden' value={{ $precio4 }}  name='precio4'  /> 
                                     <input  type='hidden' value={{ $precio5 }}  name='precio5'  /> 
                                     <input  type='hidden' value={{ $precio6 }}  name='precio6'  /> 
     ...
     <input  type='hidden' value={{ $endds}}  name="endds"  style="  width:20px; 
           ...
           <input  type='hidden' value={{ $uno }}  name="uno"  style="  width:20px; 
                                  height:5px;"/> 
...
<input  type='hidden' value={{ $precio_individuals}}  name='precio_individuals'  />               
            ...
            <input  type='hidden' value={{ $precioextra }}  name="precioextra"  style="  width:20px; 
                                  height:5px;"/> 
						...
						<div class="footerNavWrap clearfix">
                         ...
                         <button type="submit" title="Send Message" value="Send" name="send" class="btn btn-success btn-xs" style="background-color: #47775D;font-family:Century Gothic;font-size:16px">CHECKOUT</button>
						</div>
					</div>
                    </form>
	</div>
