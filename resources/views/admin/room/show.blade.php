                        ...
                        @foreach ($posts as $post)
                          <tr>
                            ...
                            <td>{{ $post->capacity }}</td>
                              ...
                              <td><a href="{{ route('room.edit',$post->id) }}"><span class="fa fa-pencil-square-o"></span></a></td>                                 

                             <!--  <td>
                              <form id="delete-form-{{ $post->id }}" method="post" action="{{ route('room.destroy',$post->id) }}" style="display: none">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                              </form>
                              <a href="" onclick="
