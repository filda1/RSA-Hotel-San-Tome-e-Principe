    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ route('room.update',$post->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
            <div class="box-body">
               ...
               <label for="title">Name room</label>
                ...
                <div class="form-group">
                <label for="title">Iva</label>
                  <input type="text" class="form-control" id="title" name="price2" placeholder="iva" value="{{ $post->price2 }}">
                </div>
                ...
                <div class="form-group">
                <label for="title">Counter</label>
                <input type="text" class="form-control" id="title" name="infoConfirm" placeholder="counter" value="{{ $post->infoConfirm }}">
                </div>
                <div class="form-group">
            ...
            <!-- /.box-body -->
             <div class="box-footer">
              ...
              <a href='{{ route('room.index') }}' class="btn btn-warning">Back</a>
            </div>
          </form>
        </div>
        <!-- /.box -->
