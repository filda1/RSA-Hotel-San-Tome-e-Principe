...
<div class="row" style="max-width:3000px;"
        ...
        <form action="/reserve2" method="POST" role="reserve" >
           {{ csrf_field() }}
             ...
             @if(isset($datas))
                    ...
                    @for ($i =0; $i<$endds; $i++)
                        <tr>
                            <td class="col-md-9"><em style="font-family:Century Gothic;font-size:16px">{{$datas[0] ->name_room}}</em></h4></td>
                ...
                <div style="display: none">       
                    ...
                    @if (($T1 =="OK") && ($numero_dias > 3))
                      ...
                      <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{ number_format($datas[0] ->activity, 0) }} </td>
                      
                      <input  type='hidden' value={{ number_format($datas[0] ->activity, 2) }}  name='precio_temporada'/> 
                    ...
                    @if (($T1 =="OK") && ($numero_dias <= 3))
                       ...
                       <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{$datas[0] ->price}} </td>
                       
                       <input  type='hidden' value={{ $datas[0] ->price }}  name='precio_temporada'/> 
                    ...
                    @if (($T2 =="OK") && ($numero_dias > 3))
                      ...
                      <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{ number_format($datas[0] ->service, 0) }} </td>
                      
                      <input  type='hidden' value={{ number_format($datas[0] ->service, 2) }}  name='precio_temporada'/>
                      
                    @endif 

                   @if (($T2 =="OK") && ($numero_dias <= 3)) 

                       <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{$datas[0] ->price2}} </td>
                       
                       <input  type='hidden' value={{ $datas[0] ->price2 }}  name='precio_temporada'/> 
                   ...
                   @if (($T4 =="OK") && ($numero_dias <= 3))
                    ...
                    @endif
                     ...
                     <!--*************************************************************************************************-->
                        ...
                        <input  type='hidden' value={{$datas[0]  ->id}}  name={{ (string)$i }}  style="  width:20px; 
                                  height:5px;"/> 
                            ...
                            @endfor
                             ...
                             @for ($i =0; $i<$endis; $i++)
                        <tr>
                            <td class="col-md-9"><em style="font-family:Century Gothic;font-size:16px">{{$dataexs[0] ->name_room}}</em></h4></td>
                            <td class="col-md-1" style="font-family:Century Gothic;font-size:16px;text-align: center">1</td>
                ...
                <div style="display: none">       
                    ...
                    @if (($T1 =="OK") && ($numero_dias > 3))
                      ...
                      <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{ number_format($dataexs[0] ->activity, 0) }} </td>
                      
                      <input  type='hidden' value={{ number_format($dataexs[0] ->activity, 0) }}  name='precio_temporada'/> 
                    ...
                    @if (($T1 =="OK") && ($numero_dias <= 3))
                       ...
                       <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{$dataexs[0] ->price}} </td>
                       
                       <input  type='hidden' value={{ $dataexs[0] ->price }}  name='precio_temporada'/> 
                    ...
                    @if (($T2 =="OK") && ($numero_dias > 3))
                      ...
                      <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{ number_format($dataexs[0] ->service, 0) }} </td>
                      
                      <input  type='hidden' value={{ number_format($dataexs[0] ->service, 0) }}  name='precio_temporada'/>
                      
                    @endif 

                   @if (($T2 =="OK") && ($numero_dias <= 3)) 

                       <td class="col-md-1 text-center" style="font-family:Century Gothic;font-size:16px">€{{$dataexs[0] ->price2}} </td>
                       
                       <input  type='hidden' value={{ $dataexs[0] ->price2 }}  name='precio_temporada'/> 
                   ...
                   @if (($T4 =="OK") && ($numero_dias <= 3))
                    ...
                    @endif
                     ...
                     <!--*************************************************************************************************-->
                        ...
                        <input  type='hidden' value={{$dataexs[0]  ->id}}  name={{ (string)$i }}  style="  width:20px; 
                                  height:5px;"/> 
                              ...
                              <input  type='hidden' value={{ $precio_baby }}  name='precio_baby'  />   
                                <input  type='hidden' value={{ $endis}}  name="endis"  style="  width:20px; 
                                  ...
                                  <input  type='hidden' value="si"  name="superior"  style="  width:20px; 
                                  height:5px;"/> 
                                    <input  type='hidden' value="6"  name='idis'>
                 ...
                 <input  type='hidden' value={{ $superior }}  name='superior'>
                   <input  type='hidden' value={{ $endds}}  name="endds"  style="  width:20px; 
                    ...
                    <input  type='hidden' value="1"  name="uno"  style="  width:20px; 
                                  ...
                                  <input  type='hidden' value={{ $precio_individual }}  name='precio_individual'  />
                                  <input  type='hidden' value={{ $cama }}  name='cama'  />
                ...
                <div class="card-header">
                       ...
                       <div class="card-body">
                         ...
                         <button type="button" class="close" data-dismiss="alert">&times;</button>
                          <strong></strong> {{ __('messages.monto') }}
                    </div>
                     </p>
