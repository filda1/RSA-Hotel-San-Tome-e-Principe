...
<div class="row" style="max-width:1000px;"
		<div class="col-lg-4">
                        ...
                        <form method="post" action="{{url('optionspayment/save')}}">
    {{ csrf_field() }}
                                  ...
                                  <input  type='hidden' value={{ $precio_children }}  name='precio_children'  />  
                                   ...
                                   <input  type='hidden' value={{ $precio_baby }}  name='precio_baby'  />
                                    ...
                                    <input  type='hidden' value={{ $ide6 }}  name='ide6'  />
                                     ...
                                     <input  type='hidden' value={{ $endd }}  name="endd" /> 
                                  
                                  <input  type='hidden' value={{ $endi }}  name="endi" /> 

                                      <input  type='hidden' value={{ $endds }}  name="endds" /> 
                                       <input  type='hidden' value={{ $endis }}  name="endis" /> 
