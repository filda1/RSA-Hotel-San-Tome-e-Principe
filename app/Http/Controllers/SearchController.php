    ...
    public function search()
    {
      ...
      //////////////////////////////// Despues de acabar la reserva, se activa los quartos ///////////////////////////////
        ...
        $interval = $datetime1->diff($datetime2);
         ...
         //$datetime2 = new DateTime('2020-03-02');

         //$fechaActual = Carbon::now();
         
         //$fechaAyer = Carbon::tomorrow();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   if($lang=="pt"){
            ...
            if ( $person){
                 ...
                 //  DISPONIVEIS PAR (Todos qurtos diponiveis. solo si nUmero de persona 2 , comienza 1 y 1), quqrto es un select de buscador:
                 //if ( ($person % 2 == 0) ){

                  $n_registros = $person/2;

                  $data_room1   = room::where ( 'vacancies', 'LIKE', '%' . 1 . '%' )
               ...
               $persona = Input::get ( 'person' );
                ...
                if ($checkin > $checkout) {
                     ...
                     //$checkout = $checkin ;
                      ...
                      return view('hotel',compact('data','end','extra_room','extra_room2', 'checkin','checkout','persona','posts','children','baby','numero_dias','iva','infoiva','precio_children','precio_baby','dat','extra','superior','endd','endi','endds','endis','numeroquarto' )) ; 
             ...
             $persona = Input::get ( 'person' );
              ...
              if ($checkin > $checkout) {
                   ...
                   //$checkout = $checkin ;
                    ...
                    return view('hotel',compact('data','end','extra_room','extra_room2', 'checkin','checkout','persona','posts','children','baby','numero_dias','iva','infoiva','precio_children','precio_baby','dat','extra','superior','dats','extras','endds','endis','endd','endi')) ; 
