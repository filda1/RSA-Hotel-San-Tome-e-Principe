...
class Optionspayment2Controller extends Controller
{
    /**
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////      
      ...
      $uniqid = uniqid();
        ...
        $price_extraroom2 = $dataroom2->price;
            ...
            return view('invoice2',compact('data','persona', 'children', 'baby', 'persona_extraroom', 'persona_extraroom2', 'total', 'checkin', 'checkout', 'time', 'time2'
    ...
    'time_extraroom2', 'time2_extraroom2', 'newformat_extraroom2', 'newformat2_extraroom2', 'end','fin','person_roomindividual','uniqid',
    'totalfinal','iva','infoiva','precio_children','precio_baby','T1','T2','T3','T4','numero_dias','ide3','ide4','ide5','ide6','precio3',
    'precio4','precio5','precio6','dato3','dato4','dato5','dato6','roomcama1','roomcama2','roomcama3','roomcama4','datas','dataex','dataexs','superior','endd','endds','endi','endis','precioextra','uno','cama','precio_duplo','precio_duplos','precio_individual','precio_individuals','cama'));
           ...
           return view('stripe2',compact('data','persona', 'children', 'baby', 'persona_extraroom', 'persona_extraroom2', 'total', 'checkin', 'checkout', 'time', 'time2'
           , 'newformat', 'newformat2', 'id_extraroom', 'price_extraroom', 'name_extraroom', 'checkin_extraroom', 'checkout_extraroom', 'time_extraroom', 'time2_extraroom', 'newformat_extraroom'
           , 'newformat2_extraroom', 'id_extraroom2', 'price_extraroom2', 'name_extraroom2', 'checkin_extraroom2', 'checkout_extraroom2', 
           ...
           'ide6','precio3','precio4','precio5','precio6','dato3','dato4','dato5','dato6','roomcama1','roomcama2','roomcama3','roomcama4','datas','dataex','dataexs','superior','endd','endds','endi','endis','precioextra','uno','cama','precio_duplo','precio_duplos','precio_individual','precio_individuals','cama'));
        ...
        'ide6','precio3','precio4','precio5','precio6','dato3','dato4','dato5','dato6','roomcama1','roomcama2','roomcama3','roomcama4','datas','dataex','dataexs','superior','endd','endds','endi','endis','precioextra','uno','cama','precio_duplo','precio_duplos','precio_individual','precio_individuals','cama'));
           ...
           , 'newformat2_extraroom', 'id_extraroom2', 'price_extraroom2', 'name_extraroom2', 'checkin_extraroom2', 'checkout_extraroom2',
           'time_extraroom2', 'time2_extraroom2', 'newformat_extraroom2', 'newformat2_extraroom2', 'end','fin','person_roomindividual',
           'uniqid','totalfinal','iva','infoiva','precio_children','precio_baby','T1','T2','T3','T4','numero_dias','ide3',
           'ide4','ide5','ide6','precio3','precio4','precio5','precio6','dato3','dato4','dato5','dato6','roomcama1','roomcama2','roomcama3','roomcama4','datas','dataex','dataexs','superior','endd','endds','endi','endis','precioextra','uno','cama','precio_duplo','precio_duplos','precio_individual','precio_individuals','cama'));
